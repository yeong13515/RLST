...
if __name__=="__main__":
    test = stock_data_loader()
    test.load_index_data(".DJT", tick=True)
    test.load_d_data('AAPL')
    test.load_m_data('AAPL', tick=True)
