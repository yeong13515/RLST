...
import datetime
import os
from rlst.core.stock_codes import stock_codes
import config
...
class logger:
    def __init__ (self):
        log_path = config.LOG_DIR /'api'
        config_path= config.IGNORE / 'config.yaml'
...
class korea_api: #api 클래스
    def __init__(self, ):
        config_path=config.IGNORE/'config.yaml'
        token_path=config.IGNORE/'token.dat'
